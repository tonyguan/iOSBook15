...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        navigationController1.tabBarItem.image = UIImage(named: "Hei")
        ...
        navigationController2.tabBarItem.image = UIImage(named: "Ji")
        
        //设置辽宁标签
        let viewController3 = ViewController()
        let navigationController3 = UINavigationController(rootViewController: viewController3)
        navigationController3.tabBarItem.title = "辽宁"
        navigationController3.tabBarItem.image = UIImage(named: "Liao")
